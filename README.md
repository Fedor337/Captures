...
- GC-содержание: ниже 40% или выше 60% приводит к нестабильности или неспецифичности. При создании дизайна, выход при данных параметрах был нулевым, нижнию границу необходимо было опустить до 30% верхнюю до 70%. Запускаем код gc_filter.py.
